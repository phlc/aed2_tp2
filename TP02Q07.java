...
class Lista{
 ...
 //pesquisaSeqNome
	/**
	*PesquisaSeqNome - Pesquisa sequencial por nome
	*@param String nome
	*@return bool
	*/
	public boolean pesquisaSeqNome (String nome){
		boolean resp = false;
		for (int i=0; i<this.fim && !resp; i++){
			resp = this.list[i].getNome().equals(nome);
		}
