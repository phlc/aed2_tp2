...
class Lista{
 ...
 //ordenar selecao
	/**
	*ordernarSelecao - ordena a lista pelo metodo Selecao 
	*@return int[] contendo numero de comparacoes e de movimentacoes de elementos
	*/
	public int[] ordenarSelecao(){
		int[] n = new int[2];
